...
```json
[{"id": 47, "fullname": "Jane Smith", "email": "...", "phone_number": "...", "studenttype": "regular", "studentstatus": "active"}]
```
...
```json
{
  ...
  "trainers": [{"id": 1, "name": "John Doe", "email": "..."}],
...
[{
  ...
  "student_name": "Jane Smith", "student_email": "...",
