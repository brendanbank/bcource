...
curl -I -k https://grafana-upstream:3000 2>&1 | head -20
echo ""

echo "2. Testing proxy connection (grafana.example.com):"
curl -I https://grafana.example.com 2>&1 | head -20
echo ""
...
curl -v -L https://grafana.example.com 2>&1 | grep -E "(Location:|HTTP/|Host:)" | head -20
echo ""
