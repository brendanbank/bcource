...
class SendEmail(SystemMessage):
    ...
    def send(self):
        ...
        msg = EmailMessage(self.render_subject(), self.render_body(), 'noreply@bcourse.nl', email_to)
...
class EmailStudentEnrolledInTraining(SendEmail):
    def process_attachment(self, msg):
        ...
        for db_event in self.kwargs['training'].trainingevents:
            ...
            #event.add(f'ORGANIZER;CN="{self.envelop_from}"', f'mailto:noreply@bcourse.nl')
