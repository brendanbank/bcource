...
Usage:
    ...
    python migrate_trainings.py --base-url https://production-host --confirm
"""
...
NEW_TRAININGS = [
    {
        ...
        "active": True,
        "apply_policies": True,
        "trainer_ids": [1, 10, 11],  # John Doe, Trainer A, Trainer B
    ...
    },
    {
        ...
        "active": True,
        "apply_policies": True,
        "trainer_ids": [1, 9, 11],  # John Doe, Trainer C, Trainer B
...
def generate_token(secret_key, user_id=108, email="admin@example.com"):
    payload = {
        "user_id": user_id,
        "email": email,
        "role": "db-admin",
